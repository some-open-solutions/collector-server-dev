	...
	if($valid_location){
		if($_POST['trial_all'] == "trial"){
			...
			try {
				...
				$body_alt_body = "Hello, <br><br> Participant $participant has just completed the task. <br><br> Their completion code was $completion_code. <br><br> To decrypt the data, please go to the 'data' tab in Collector (i.e. where you edited the experiment). <br><br> Best wishes, <br><br> $mailer_team_name.";
